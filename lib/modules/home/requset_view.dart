...
class RequsetView extends StatefulWidget {
  ...
  const RequsetView({super.key, required this.onBack,});
  @override
...
class _RequsetViewState extends State<RequsetView> {
  ...
  TextEditingController _flightNoController = TextEditingController();
  List<CarPriceModel> carList = [];
  CarPriceModel selectedCar = CarPriceModel(carId: '0',
      carImage: '',
      distance: '0',
      price: '0',
      formattedTime: '',
  ...
  Future<void> loadData() async {
    carList = await API.getAllCarsPrice(
        ...
        context);
    Provider.of<MapPro>(context, listen: false).notifyListenerz();
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  child: Card(
                                    color: selectedCar.carId == car.carId ? Theme.of(context).primaryColor : null,
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Row(
                                        children: [
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(AppLocalizations.of(selectedCar.formattedTime
