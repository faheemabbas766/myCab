...
class PhoneVerification extends StatefulWidget {
  late bool isCreate;
  PhoneVerification({this.isCreate=false});
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              AppLocalizations.of('Email Verification'),
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () async {
              if(otpController.text==Provider.of<HomePro>(context, listen: false).otp){
                if(widget.isCreate){
                  API.showLoading("Verifying Account...", context);
                  await API.updateAccountStatus(context: context);
          ...
          child: AspectRatio(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(otxt, style: Theme.of(context).textTheme.headlineSmall!.copyWith(fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ),
